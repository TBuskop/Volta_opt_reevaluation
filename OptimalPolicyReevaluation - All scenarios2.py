...
experiments_slice23 = uncertainty_scenarios[2000:2400]
...
def main():
    ...
    with MultiprocessingEvaluator(model_set) as evaluator:
        results = evaluator.perform_experiments(scenarios2, n_policies)
        save_results(results, r'./reevaluation_results/results2.tar.gz')
    end = time.time()
